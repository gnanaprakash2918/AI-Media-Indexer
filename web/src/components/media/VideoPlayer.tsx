...
import { Dialog, DialogContent, IconButton, Box, Typography, Button, Stack, LinearProgress } from '@mui/material';
...
export function VideoPlayer({ videoPath, startTime, endTime, open, onClose }: VideoPlayerProps) {
    ...
    const handleTimeUpdate = useCallback(() => {
        ...
        // Update progress bar
        const segmentProgress = ((currentTime - segmentStart) / segmentDuration) * 100;
    ...
    }, [isFullVideo, open, hasSegment, segmentStart]);
                    ...
                    <>
                        {isLoading && (
                            <Box sx={{
                                ...
                                <Typography color="text.secondary" sx={{ mb: 1 }}>Loading...</Typography>
                            </Box>
                        )}
                        <video
                            ref={videoRef}
