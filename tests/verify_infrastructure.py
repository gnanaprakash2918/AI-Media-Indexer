...
def test_library_imports() -> dict:
    ...
    try:
        ...
        print(f"   soundfile: ❌ Missing (apt-get install libsndfile1)")
    ...
    try:
        ...
        results["cv2"] = f"❌ {e}"
        print(f"   cv2: ❌ Missing (apt-get install libgl1)")
...
def test_hardware_profile() -> dict:
    ...
    try:
        from config import get_hardware_profile, HardwareProfile
